...
module.exports = {
    ...
    Pay : {
        ...
        args : {
            ...
            'DescriptorPolicy.CsOwner'            : optional,
            'DescriptorPolicy.SoftDescriptorType' : optional,
            'MarketplaceFixedFee.CurrencyCode'    : optional,
            'MarketplaceFixedFee.Value'           : optional,
            MarketplaceVariableFee   : optional,
            OverrideIpnUrl           : optionalWithName('OverrideIPNURL'),
            RecipientTokenId         : optional,
            SenderDescription        : optional,
            SenderTokenId            : required,
            'TransactionAmount.CurrencyCode'    : required,
            'TransactionAmount.Value'           : required,
            TransactionTimeoutInMins : optional,
        },
    },
    ...
    Refund : {
        ...
        args : {
            ...
            CallerReference          : required,
            OverrideIpnUrl           : optionalWithName('OverrideIPNURL'),
            'RefundAmount.CurrencyCode' : optional,
    ...
    SettleDebt : {
        ...
        args : {
            ...
            SenderDescription        : optional,
            SenderTokenId            : required,
            'SettlementAmount.CurrencyCode' : required,
            'SettlementAmount.Value'        : required,
            TransactionTimeoutInMins : optional,
        },
    },
    ...
    WriteOffDebt : {
        ...
        args : {
            Action             : required,
            'AdjustmentAmount.CurrencyCode' : required,
            'AdjustmentAmount.Value'        : required,
            CallerDescription  : optional,
            CallerReference    : required,
            CreditInstrumentId : required,
        },
